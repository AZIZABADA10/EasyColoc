...
<head>
    ...
    <title>@yield('title', 'Profile - EasyColoc')</title>
            ...
            <div class="bg-white/80 backdrop-blur-md border-b border-slate-200 px-8 py-4 flex justify-between items-center shadow-sm">
                ...
                <div class="flex items-center space-x-6">
                    ...
                    <form method="POST" action="{{ route('logout') }}" class="inline">
                        @csrf
                        <button type="submit" class="text-slate-600 hover:text-red-600 font-medium text-sm transition duration-200 hover:bg-red-50 px-3 py-2 rounded-lg">
                            Déconnexion
                        </button>
                    </form>
                </div>
